...
void sharpCPU::opcode27()
{
	...
	else
	{
		...
		if (beakMemory.getCFlag() || (aValue > 0x9F))
		{
			aValue += 0x60;
		}
	}
...
void sharpCPU::opcode98()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getB() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getB() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getB() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode99()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getC() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getC() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getC() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9A()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getD() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getD() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getD() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9B()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getE() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getE() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getE() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9C()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getH() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getH() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getH() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9D()
{
	...
	else
	{
		...
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getL() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getL() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9E()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.readMemory(beakMemory.getHL()) + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.readMemory(beakMemory.getHL()) + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.readMemory(beakMemory.getHL()) + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
	}
...
void sharpCPU::opcode9F()
{
	...
	{
		beakMemory.setHFlag(beakMemory.getA() < (beakMemory.getA() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((beakMemory.getA() > 0x0F) && ((beakMemory.getA() - (beakMemory.getA() + beakMemory.getCFlag())) <= 0x0F));
		beakMemory.setA(beakMemory.getA() - (beakMemory.getA() + beakMemory.getCFlag()));
		//beakMemory.setHFlag((((beakMemory.getA()) & 0x0F) == 0xF) ? 1 : 0);
		beakMemory.setCFlag(false);
...
void sharpCPU::opcodeE8(byte n)
{
	...
	{
		beakMemory.setA((stackPointer + n) - 65536);//0xFFFF);
		beakMemory.setHFlag(true);
		beakMemory.setCFlag(true);
	}
	else
	{
		beakMemory.setHFlag((stackPointer <= 0x0F) && ((stackPointer + n) > 0x0F));
		beakMemory.setA(stackPointer + n);
	...
	//beakMemory.setZFlag((beakMemory.getA() == 0) ? 1 : 0); //From tests in BGB this is not set
	beakMemory.setNFlag(false);
}
