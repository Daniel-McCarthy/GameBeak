...
class Memory
{
	...
	void changeRomBanks(int bankNumber)
	{
		...
		int bankAddress = 0x4000 * bankNumber; //0x4000
	...
	void loadSGBBootStrapIntoMemory()
	{
		vector<byte> boot = {
			
		};

		for (int i = 0; i < (int)boot.size(); i++)
		{
			writeMemory(i, boot[i]);
		}
	}
	...
	*/
	...
	bool writeMemory(int address, short shortVal)
	{
		...
		if (address >= 0 && address < 4096)
		{
			...
			if (((beakRam[address] << 8) | beakRam[address + 1]) == shortVal)
			{
				return true;
			}
			else
	...
	*/
	...
	{
		//Sets Gameboy values at start. Temporary until bios can be read fully
